...
* **Backend:** Firebase (utilizing Firebase Realtime Database for core real-time game state, Firebase Cloud Functions for backend logic and AI integration, and Firebase Authentication).
